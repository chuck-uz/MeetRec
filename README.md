...
- **Чат с ИИ по встрече** (Mac с 16+ ГБ памяти) — саммари, action items, решения, письмо-фоллоуап или свободный вопрос по любому транскрипту. Локальная модель Qwen 2.5 7B через встроенный [llama.cpp](https://github.com/ggml-org/llama.cpp) (Metal); модель ~4,7 ГБ скачивается при первом использовании, выгружается после 5 минут простоя. Ответы не покидают Mac.
